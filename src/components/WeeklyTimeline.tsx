    ...
    <div className="relative space-y-0">
      ...
      {sorted.map((week) => (
        <div key={week.week} className="relative flex gap-4 pb-6">
          {/* Dot */}
          <div className="relative z-10 mt-1.5 flex h-[22px] w-[22px] shrink-0 items-center justify-center rounded-full border-2 border-accent bg-surface">
          ...
          <div className="min-w-0 flex-1">
            <div className="mb-1 flex items-center gap-2">
              ...
              <Link
                ...
                className="flex items-center gap-1 rounded-md bg-accent/10 px-2 py-0.5 text-xs font-medium text-accent hover:bg-accent/20 transition-colors"
              >
                <BookOpen size={11} />
                View page
              </Link>
            </div>
            <p className="mb-2 text-xs text-text-dim leading-relaxed line-clamp-2">
              {week.summary}
            </p>
